...
class LoginPage extends React.Component {
    ...
    constructor(props) {
        super(props);
        // reset login status
        this.props.dispatch(userActions.clearlogin());
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        <button className="btn btn-primary">{this.activeTranslation.login}</button>
                        {loggingIn &&
                            <img alt="Wainting ..." src="data:image/gif;base64," />
                        }
                    </div>
                </form>
            </div>
