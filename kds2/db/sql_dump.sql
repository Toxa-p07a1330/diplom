...
--
-- Current Database: `art`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `art` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `th` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `terminals` (
  ...
  `key4` varchar(45) DEFAULT NULL,
  `key5` varchar(45) DEFAULT NULL,
  `key6` varchar(45) DEFAULT NULL,
  `key7` varchar(45) DEFAULT NULL,
  `key8` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `kds` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `applications` (
  ...
  PRIMARY KEY (`id`),
  KEY `app_model_idx` (`modelid`),
  CONSTRAINT `app_model` FOREIGN KEY (`modelid`) REFERENCES `termmodels` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29964 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-08 13:29:42
